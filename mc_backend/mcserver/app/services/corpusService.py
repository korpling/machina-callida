...
from mcserver.app.models import Corpus, CitationLevel, GraphData, Solution, ExerciseType, Phenomenon, FrequencyAnalysis, \
    AnnisResponse, SolutionElement
...
class CorpusService:
    ...
    def add_corpus(title_value: str, urn: str, group_name_value: str,
        ...
        new_corpus = Corpus(title=title_value,
                            source_urn=urn,
                            author=group_name_value,
    ...
    def update_corpora():
        ...
        for textGroup in ti:
            ...
            for work in textGroup.findall("./work"):
                ...
                if urn not in urn_set_existing:
                    ...
                    corpus_to_update: Corpus = Corpus.query.filter_by(source_urn=urn).first()
        ...
        for urn in urn_set_existing:
            if urn not in urn_set_new:
                corpus_to_delete: Corpus = Corpus.query.filter_by(source_urn=urn).first()
